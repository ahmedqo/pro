                ...
                <div class="w-full flex flex-col gap-4">
                    ...
                    <div class="w-full flex flex-col gap-2">
                        ...
                        <div class="w-full relative">
                            <input id="password-input" name="password" type="password" placeholder="Mot de passe"
                                class="h-12 text-md w-full bg-gray-50 text-gray-900 px-4 py-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 border-none" />
                            <div class="absolute top-0 right-4 h-full rounded-md py-2 flex gap-2 items-center">
                                <button data-password-trigger data-target="#password-input"
                                    data-mutable="#password-show|#password-hide" type="button"
                                    ...
                                    <svg id="password-hide" class="hidden text-grey-900 w-5 h-5" fill="currentcolor"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                        <path
                    ...
                    <div class="w-full flex flex-col md:flex-row justify-between items-center gap-2">
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="text-blue-500 underline order-2 md:order-1">

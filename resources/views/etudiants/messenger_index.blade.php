...
@section('content')
    <div class="flex gap-4 items-center justify-between">
        ...
        <a href="{{ route('send.messsage') }}"
            class="flex items-center shadow-md justify-between cursor-pointer p-2 rounded-md focus:outline-none bg-blue-500 focus:bg-blue-300 hover:bg-blue-300">
            <svg class="text-white w-5 h-5" fill="currentcolor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path
                    d="M22.3 28.3H25.75V21.8H32.25V18.35H25.75V11.85H22.3V18.35H15.8V21.8H22.3ZM2.95 45V7.55Q2.95 5.7 4.3 4.325Q5.65 2.95 7.5 2.95H40.5Q42.35 2.95 43.725 4.325Q45.1 5.7 45.1 7.55V32.6Q45.1 34.45 43.725 35.8Q42.35 37.15 40.5 37.15H10.8Z" />
            </svg>
        </a>
    </div>
        ...
        <div class="p-4 text-left w-full bg-white shadow-md rounded-md flex-1 md:order-1">
            <div class="w-full flex flex-col gap-4">
                @forelse ($threads as $row)
                    <div
                        class="flex items-center gap-2 rounded-md px-4 py-2 text-grey-900 {{ $row->userUnreadMessagesCount(Auth::id()) ? 'bg-blue-50' : 'bg-gray-50' }}">
                        ...
                        <div class="flex ml-auto md:ml-0">
                            <a href="{{ route('messages.destroy', $row->id) }}"
